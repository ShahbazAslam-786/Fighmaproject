      ...
      <div className="sidebar">
        <div className="sidebar-content">
          <div className="menu-items">
            ...
            >
              <img src={taskImage || "/placeholder.svg"} alt="taskImage" className="menu-icon" />
              Task
            </div>
            <div
            ...
            >
              <img src={locationIcon || "/placeholder.svg"} alt="locationIcon" className="menu-icon" />
              Location
            </div>
          </div>
          <div className="logout">
            <img src={logoutIcon || "/placeholder.svg"} alt="logoutIcon" className="menu-icon" />
            Logout
          </div>
        </div>
      </div>
                ...
                {incompleteTasks.map((task) => (
                  <div key={task.id} className="task-item">
                    ...
                    <div className="task-content">
                      ...
                      {task.dueDate && <div className="task-due-date">🕒 {task.dueDate}</div>}
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="location-section">
              ...
              <div className="location-item">
                ...
                <div className="location-content">
                  <div className="location-name">{locations.find((loc) => loc.type === "current")?.name}</div>
                  <div className="location-time">{locations.find((loc) => loc.type === "current")?.time}</div>
                </div>
              </div>
            </div>
